...
msts_train<-train %>% msts(seasonal.periods = c(5, 6*2))
msta_test<-test%>% msts(seasonal.periods = c(5, 6*2))
...
tbats_model <-  forecast(tbats_mod,h=12) 

accuracy_df  = plotsumm(tbats_model, "Multiple seasonality", msta_test)
...
accuracy_long = accuracy_df %>%
                   ...
                   rename(error = value) %>%
                   filter(model_name != "Average" & 
                          model_name != "Naive"   &
                          model_name != "SES"     &
                          model_name != "Random Walk w/ drift" & 
                          model_name != "Seasonal Naive" &
                          model_name != "ETS - diff" &
                          model_name != "TBATS - diff" & 
                          model_name != "Holt Winters - diff")
